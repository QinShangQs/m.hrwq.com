<ul id="nav"><!--导航，所在li需添加类selected-->
    <li @if($selected_item == 'nav1')class="selected" @endif><a class="nav_1" href="{{route('course')}}" title="好课"></a></li>
    <li @if($selected_item == 'nav2')class="selected" @endif><a class="nav_2" href="{{route('vcourse')}}" title="好看"></a></li>
    <?php //<li @if($selected_item == 'nav3')class="selected" @endif><a class="nav_3" href="{{route('opo')}}" title="壹家壹"></a></li>?>
    <li @if($selected_item == 'nav4')class="selected" @endif><a class="nav_4" href="{{route('question')}}" title="好问"></a></li>
