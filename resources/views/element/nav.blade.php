<ul id="nav"><!--导航，所在li需添加类selected-->
    ...
    <li @if($selected_item == 'nav4')class="selected" @endif><a class="nav_4" href="{{route('question')}}" title="问答"></a></li>
    <li @if($selected_item == 'nav1')class="selected" @endif><a class="nav_1" href="{{route('course')}}" title="活动"></a></li>
