        ...
        <div id="main">
            ...
            <div class="one_plus_one">
                ...
                <div class="opo_div1">
                    ...
                    <div class="opo_div1_button" style=" background:#999999;">已购买</div>
                </div>
                <div class="opo_div">
                ...
                <div class="opo_div">
                    ...
                    <div class="opo_div_img"><img src="/images/opo/step_{{$order->order_opo->process}}.jpg" alt=""/>
                    </div>
                </div>
                @if($order->order_opo->process == 5)
                    <div class="opo_div">
                        <div class="opo_div_title">服务报告</div>
                        <div class="opo_div_p">
                            <p>{{$order->order_opo->service_comment}}</p>
                        </div>
                        @if(empty($previews))
                            <a href="{{qiniu_url($order->order_opo->service_url)}}"
                               download="{{$order->order_opo->service_url}}">
                                <div class="opo_div_button">查看</div>
                            </a>
                        @else
                            <a href="{{route('opo.report.previews', ['id'=>$order->id])}}">
                                <div class="opo_div_button">查看</div>
                            </a>
                        @endif
                ...
                <div class="opo_div">
                    ...
                    <a href="{{route('opo.comment.create', ['id'=>$opo->id])}}" class="opo_div_a">我要评论</a>
