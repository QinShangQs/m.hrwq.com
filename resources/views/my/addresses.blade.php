        ...
        $(document).ready(function () {
            ...
            function output() {//输出收货地址列表
                ...
                for (var i = 0; i < addresses.length; i++) {
                    ...
                    ' + html_default + '\
                    <div class="address_choice_button" data-id="0">\
            ...
            //编辑地址/提交新地址
            $(document).on("click",".address_choice_form_button",function(){
            ...
            //删除地址
            $(document).on("click", ".address_choice_delete", function () {
            ...
            //修改默认地址
            $(document).on("click", ".address_choice_default", function () {
                var id=$(this).attr("data-id");
                if (confirm("确定设为默认地址?")) {
                    $.ajax({
                        type: 'post',
