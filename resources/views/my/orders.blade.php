                                ...
                                <div>
                                    ...
                                    <div style="padding: .775rem;padding-top: 0">
                                        ...
                                        <div>
                                            ...
                                            @endforeach
<!--                                            <span onclick="tuangouShare('{{ @str_limit(@$value->course->title,20) }}','拼团中', '{{route("course.detail")}}/{{@$value->course->id}}?team_id={{$team_id}}','{{config('constants.admin_url').@$value->course->picture}}')"> -->
                                                <!--点击分享-->
                                            <span onclick="location.href='/user/orders/members/{{$team_id}}'">
