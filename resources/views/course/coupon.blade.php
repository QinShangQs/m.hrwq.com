...
$(document).ready(function(){
    ...
    $(".mcc_list1 li").click(function(){//点击可使用优惠券
        ...
        var package_flg = '{{$package_flg}}';// 单人或者家庭套餐
        var package_prices = '{{$package_prices}}';// 单人或者家庭套餐
        ...
        window.location.href = url + "?temp=2" + "&coupon_user_id=" + coupon_user_id + "&coupon_id=" + coupon_id + "&coupon_type=" + coupon_type + "&coupon_cutmoney=" + coupon_cutmoney  
            + "&coupon_discount=" + coupon_discount + "&package_flg="+ package_flg + "&package_prices="+ package_prices + "&number=" + number + "&is_point=" + is_point +
