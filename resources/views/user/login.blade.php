            ...
            <form action="" method="" class="login_form">
                ...
                <div class="login-form" style="color: #999;font-size:0.75rem;margin:4.16rem 1.2rem 1rem 1.2rem;padding:0 0.75rem;background-color:#fff">
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td colspan="2" align=center style="padding-top: 1.125rem">
...
$(document).ready(function () {
    ...
    $(".login_code1").click(function () {//获取验证码
        ...
        if (!mobile.match(/^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(16[0-9]{1})|(19[0-9]{1})|(14[0-9]{1}))+\d{8})$/)) {
            Popup.init({
    ...
    $(".login_button").click(function () {
        ...
        var c_sex = $('select[name="c_sex"]').val();
        var c_age = $.trim($('input[name="c_age"]').val());
        
        var _waring = function(msg){
            Popup.init({
                popHtml: '<p>'+msg+'</p>',
                popFlash: {
                    flashSwitch: true,
        ...
        if(c_sex == ""){
            _waring('为了给您提供更匹配的课程，请选择孩子性别');
            return false;
        }
        
        if(c_age == ""){
            _waring('为了给您提供更匹配的课程，请输入孩子年龄');
            return false;
        }
        
        if(isNaN(c_age) || parseInt(c_age) <= 0){
            _waring('为了给您提供更匹配的课程，请真确输入孩子年龄');
        }
        
        if (!mobile.match(/^(((13[0-9]{1})|(15[0-9]{1})|(16[0-9]{1})|(19[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(14[0-9]{1}))+\d{8})$/)) {
            _waring('请输入正确的手机号码');
            return false;
        }
        if (code == "") {
